                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pl-12">
                        {q.options.map((option, oIdx) => {
                          ...
                          if (showResults) {
                            ...
                            cardClass += isSelected ? "bg-[#dff3ee] text-[#12343b] border-[#1f4d57] shadow-[0_12px_28px_rgba(31,77,87,0.14)] ring-2 ring-[#8fc4b8] " : "hover:border-[#7aa6a2] hover:bg-white ";
                          }
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className={isSelected && !showResults ? 'font-semibold text-[#12343b]' : ''}>{option}</span>
